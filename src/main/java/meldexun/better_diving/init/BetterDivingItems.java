...
public class BetterDivingItems {
	...
	public static final DeferredRegister<Item> ITEMS =
			DeferredRegister.create(ForgeRegistries.ITEMS, BetterDiving.MOD_ID);

	public static final RegistryObject<Item> TITANIUM_CHUNK = ITEMS.register(
			"titanium_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> COPPER_CHUNK = ITEMS.register("copper_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> SILVER_CHUNK = ITEMS.register("silver_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> LEAD_CHUNK = ITEMS.register("lead_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> LITHIUM_CHUNK = ITEMS.register("lithium_chunk", () -> new Item(new Item.Properties()));

	public static final RegistryObject<Item> COAL_CHUNK = ITEMS.register("coal_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> IRON_CHUNK = ITEMS.register("iron_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> GOLD_CHUNK = ITEMS.register("gold_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> REDSTONE_CHUNK = ITEMS.register("redstone_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> LAPIS_CHUNK = ITEMS.register("lapis_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> EMERALD_CHUNK = ITEMS.register("emerald_chunk", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> DIAMOND_CHUNK = ITEMS.register("diamond_chunk", () -> new Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> FIBER_MESH = ITEMS.register("fiber_mesh", () -> new Item(new Item.Properties()));
	...
	public static void registerItems() {
		for (RegistryObject<Block> block :
			...
			ITEMS.register(block.getId().getPath(), () -> new BlockItem(block.get(),
					new Item.Properties()));
		}
